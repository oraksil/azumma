...
func TestSignalingUseCaseNewOffer(t *testing.T) {
	...
	mockGameRepo.On("FindRunningGameByOrakkiId", "1").Return(mockGame, nil)

	mockSignalRepo := new(MockSignalingRepository)
	mockSignalRepo.On("SaveSignalingInfo", mock.Anything).Return(mock.Anything, nil)
	...
	useCase := SignalingUseCase{
		...
		SignalingRepository: mockSignalRepo,
